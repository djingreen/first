        ...
        <main id="js-page-content" role="main" class="page-content">
            <div class="col-md-12">
                <div id="panel-1" class="panel">
                    ...
                    <?php
                    $pictures = [
                        [ "picture_link" => "img/demo/gallery/21.jpg",
                          "picture_preview" => "img/demo/gallery/thumb/21.jpg"
                        ],
                        [ "picture_link" => "img/demo/gallery/22.jpg",
                          "picture_preview" => "img/demo/gallery/thumb/22.jpg"
                        ],
                        [ "picture_link" => "img/demo/gallery/23.jpg",
                          "picture_preview" => "img/demo/gallery/thumb/23.jpg"
                        ],
                        [ "picture_link" => "img/demo/gallery/24.jpg",
                          "picture_preview" => "img/demo/gallery/thumb/24.jpg"
                        ],
                        [ "picture_link" => "img/demo/gallery/25.jpg",
                          "picture_preview" => "img/demo/gallery/thumb/25.jpg"
                        ],
                        [ "picture_link" => "img/demo/gallery/26.jpg",
                          "picture_preview" => "img/demo/gallery/thumb/26.jpg"
                        ],
                    ];
                    ?>
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <div id="js-lightgallery">
                                ...
                                <a class="" href="<?php echo $picture['picture_link'];?>">
                                    <img class="img-responsive" src="<?php echo $picture['picture_preview'];?>" alt="image">
                                </a>
                                <?php endforeach;?>
