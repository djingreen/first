                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <div class="d-flex mt-2">
                                <?php echo $indicator['title'];?>
<!--                                My Tasks-->
                                <span class="d-inline-block ml-auto"><?php echo $indicator['value'];?></span>
                            </div>
                            <div class="progress progress-sm mb-3">
                                <div class="progress-bar <?php echo $indicator['background'];?>" role="progressbar" style="width: <?php echo $indicator['width'];?>;" aria-valuenow="<?php echo $indicator['valuenow'];?>" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <?php endforeach;?>
                            <div class="d-flex">
<!--                            </div>-->
