            ...
            <div class="row js-list-filter" id="js-contacts">
                ...
                $users = [
                    [
                        ...
                        "name"        => "Oliver Kopyov",
                        "status"      => "success",
                        "job_company" => "IT Director, Gotbootstrap Inc.",
                    ...
                    [   "id"          =>  "2",
                        ...
                        "name"        => "Sesha Gray",
                        "status"      => "warning",
                        "job_company" => "Project Manager, Gotbootstrap Inc.",
                    ...
                    [   "id"          =>  "3",
                        ...
                        "status"      => "danger",
                        "job_company" => "Human Resources, Gotbootstrap Inc.",
                    ...
                    [   "id"          =>  "4",
                        ...
                        "name"        => "Jim Ketty",
                        "status"      => "success",
                        "job_company" => "Staff Orgnizer, Gotbootstrap Inc.",
                    ...
                    [   "id"          =>  "5",
                        ...
                        "name"        => "Dr. John Oliver",
                        "status"      => "success",
                        "job_company" => "Oncologist, Gotbootstrap Inc.",
                    ...
                    [   "id"          =>  "6",
                        ...
                        "name"        => "Sarah McBrook",
                        "status"      => "success",
                        "job_company" => "Xray Division, Gotbootstrap Inc.",
                        "phone"       => " +1 313-461-1347",
                    ...
                    [   "id"          =>  "7",
                        ...
                        "name"        => "Jimmy Fellan",
                        "status"      => "success",
                        "job_company" => "Accounting, Gotbootstrap Inc.",
